-- Taken as is from https://github.com/quartznet/quartznet/blob/main/database/tables/tables_sqlServer.sql
-- With an additional table creation bit at the start taken from the default creation script in .NET Aspire
